...
/**
* This class is a lookup table of constants for all the
* Java Virtual Machine's opcodes.
*
* @author  Bill Venners
*/
public class OpCode {
    ...
    public final static int INVOKENONVIRTUAL = 183;
    ...
    public final static int RET_W = 209;
}
